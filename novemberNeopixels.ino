...
void loop() {
  ...
  revColorWipe(ORANGE, 100);
  
  colorWipe(YELLOW, 110);

  revColorWipe(RED, 120);
  
  colorWipe(ORANGE, 130);
  
  revColorWipe(YELLOW, 140);

  colorWipe(RED, 150);
  
  revColorWipe(ORANGE, 160);
  
  colorWipe(YELLOW, 170);
   
  revColorWipe(RED, 180);
  
  colorWipe(ORANGE, 190);

  flashBetween(YELLOW, RED, 150);

  onePixel(ORANGE, 50);

  twoPixels(YELLOW, RED, 50);

  onePixel(ORANGE, 50);

  twoPixels(YELLOW, RED, 50);

  policeChase(ORANGE, YELLOW, 50);

  policeChase(RED, ORANGE, 50);
}
