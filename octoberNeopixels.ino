...
uint32_t GREEN = strip.Color(25, 250, 50);
...
void loop() {
  ...
  revColorWipe(PURPLE, 50);
  
  colorWipe(GREEN, 50);
  
  revColorWipe(ORANGE, 50);
   
  colorWipe(PURPLE, 50);
  
  revColorWipe(GREEN, 50);
  ...
  flashBetween(PURPLE, GREEN, 150);

  onePixel(PURPLE, 50);

  twoPixels(GREEN, ORANGE, 50);

  onePixel(PURPLE, 50);

  twoPixels(GREEN, ORANGE, 50);

  policeChase(PURPLE, GREEN, 50);
